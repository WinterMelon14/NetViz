...
# Bounds recursive schema-v2 arguments and model-provided values.
MAX_STRUCTURED_INPUT_DEPTH = 8
MAX_STRUCTURED_CONTAINER_ITEMS = 128
MAX_STRUCTURED_INPUT_VALUES = 1_024
MAX_INPUT_STRING_CHARS = 64 * 1024
MAX_INPUT_SERIALIZED_BYTES = 256 * 1024
